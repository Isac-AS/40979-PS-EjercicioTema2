...
import control.frontCommand.FrontCommand;
import control.frontCommand.UnknownCommand;
...
public class FrontController extends HttpServlet {
    ...
    private Class getCommandClass (HttpServletRequest request) {
        Class result;
        final String command = "control.frontCommand." + (String) request.getParameter("command");
        try {
